...
SECRET_KEY = "django-insecure-nhw#8zf(1a3tyu26@6bzud2chx9_urvggxpe%&uet*d(@=3p9-"
...
#add the media settings for the image uploads
MEDIA_URL = '/media/'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'khanihtesham0332@gmail.com' # Your email [cite: 3, 58]

# IMPORTANT: This is NOT your login password. 
# It must be a 16-character "App Password".
